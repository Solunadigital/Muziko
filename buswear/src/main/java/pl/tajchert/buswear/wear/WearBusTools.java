...
public class WearBusTools {
    ...
    public final static String DATA_CHANGED_KEY = "KEY";
    public final static String DATA_CHANGED_BITMAP = "BITMAP";
    public final static String DATA_CHANGED_CLASS = "CLASS";
    public final static String DATA_CHANGED_TIME = "TIME";
