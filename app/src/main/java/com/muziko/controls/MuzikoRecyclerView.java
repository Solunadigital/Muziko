...
public class MuzikoRecyclerView extends RecyclerView {
	...
	private MuzikoRecyclerAdapter<?> mViewPagerAdapter;
	...
	public MuzikoRecyclerView(Context context) {
		this(context, null);
	}

	public MuzikoRecyclerView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MuzikoRecyclerView(Context context, AttributeSet attrs, int defStyle) {
	...
	public MuzikoRecyclerAdapter getWrapperAdapter() {
	...
	@NonNull
	private MuzikoRecyclerAdapter ensureRecyclerViewPagerAdapter(Adapter adapter) {
		return (adapter instanceof MuzikoRecyclerAdapter)
				? (MuzikoRecyclerAdapter) adapter
				: new MuzikoRecyclerAdapter(this, adapter);
