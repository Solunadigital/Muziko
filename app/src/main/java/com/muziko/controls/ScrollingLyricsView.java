...
public class ScrollingLyricsView extends View {
	...
	public ScrollingLyricsView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initViews(attrs);
	}

	public ScrollingLyricsView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void initViews(AttributeSet attrs) {
		...
		Typeface light = LyricsTextFactory.FontCache.get("thin", getContext());
		Typeface regular = LyricsTextFactory.FontCache.get("regular", getContext());
		mNormalPaint.setTypeface(regular);
