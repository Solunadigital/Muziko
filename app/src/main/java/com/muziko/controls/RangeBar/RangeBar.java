...
public class RangeBar extends View {
    ...
    private boolean disableRightThumb = false;
    private PinTextFormatter mPinTextFormatter = value -> {
        if (value.length() > 4) {
    ...
    public boolean isDisableRightThumb() {
        return disableRightThumb;
    }
