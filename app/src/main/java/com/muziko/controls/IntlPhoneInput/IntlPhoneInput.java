package com.muziko.controls.IntlPhoneInput;
...
//            setHint();
    ...
    private void setEditTextDefaults(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.IntlPhoneInput);
        int textSize = a.getDimensionPixelSize(R.styleable.IntlPhoneInput_intlPhoneInputTextSize, getResources().getDimensionPixelSize(R.dimen.text_size_default));
        mPhoneEdit.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        int color = a.getColor(R.styleable.IntlPhoneInput_intlPhoneInputTextColor, -1);
        if (color != -1) {
