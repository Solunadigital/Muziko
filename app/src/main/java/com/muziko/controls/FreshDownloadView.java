...
public class FreshDownloadView extends View {
    ...
    private void parseAttrs(TypedArray array) {
        if (array != null) {
            try {
                ...
                setCircularColor(array.getColor(R.styleable.FreshDownloadView_circular_color, ContextCompat.getColor(getContext(), R.color.default_circular_color)));
                setProgressColor(array.getColor(R.styleable.FreshDownloadView_circular_progress_color, ContextCompat.getColor(getContext(), R.color.default_circular_progress_color)));
    ...
    private AnimatorSet getPrepareAnimator() {
        ...
        downAnimaor.addUpdateListener(animation -> {
    ...
    private synchronized void setProgressInternal(float progressInternal) {
    ...
    private void setProgressTextSize(float mProgressTextSize) {
    ...
    private int getCircularColor() {
        return circular_color;
    }

    private void setCircularColor(int circular_color) {
    ...
    private void setProgressColor(int circular_progress_color) {
    ...
    private void setCircularWidth(float circular_width) {
