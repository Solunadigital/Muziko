...
package com.muziko.controls.Seekbar.internal;
 ...
 * and the {@link drawable.MarkerDrawable}
...
public class Marker extends ViewGroup implements MarkerDrawable.MarkerAnimationListener {
	...
	public Marker(Context context, AttributeSet attrs, int defStyleAttr, String maxValue, int thumbSize, int separation) {
		...
		int textAppearanceId = a.getResourceId(R.styleable.MuzikoSeekBar_dsb_indicatorTextAppearance,
...
//		mNumber.setTextAppearance(context, textAppearanceId);
		...
		ColorStateList color = a.getColorStateList(R.styleable.MuzikoSeekBar_dsb_indicatorColor);
		...
		float elevation = a.getDimension(R.styleable.MuzikoSeekBar_dsb_indicatorElevation, ELEVATION_DP * displayMetrics.density);
