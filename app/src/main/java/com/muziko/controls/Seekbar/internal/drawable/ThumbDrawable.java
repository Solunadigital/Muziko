...
package com.muziko.controls.Seekbar.internal.drawable;
 ...
 * </p>
 * <p>
 * It's special because it will stop drawing once the state is pressed/focused BUT only after a small volume.
 * </p>
 * <p>
 * This special volume is meant to help avoiding frame glitches while the {@link } is added to the Window
 * </p>
 *
 * @hide
 */
...
//			canvas.drawRect((bounds.centerX() - radius / 2), (bounds.centerY() - radius / 2),(bounds.centerX() + radius / 2),(bounds.centerY() + radius / 2), paint);
		}
	}
