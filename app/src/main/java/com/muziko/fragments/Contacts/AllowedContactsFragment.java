...
public class AllowedContactsFragment extends BaseFragment implements ContactsCallback, ShareListener, ActionMode.Callback, OnFastScrollStateChangeListener {
    ...
    public AllowedContactsFragment() {
        ...
        if (persons.size() > 0) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.contact_block:
                    ...
                    new MaterialDialog.Builder(getActivity()).theme(Theme.LIGHT).titleColorRes(R.color.normal_blue).negativeColorRes(R.color.dialog_negetive_button).positiveColorRes(R.color.normal_blue).title(R.string.block_contacts).content(R.string.confirm_block_contacts).positiveText(R.string.block).onPositive((dialog, which) -> {
