...
import static com.muziko.R.id.itemList;

/**
 * Created by dev on 2/11/2016.
 */

public class ContactsFragment extends BaseFragment implements ContactsCallback, ShareListener, ActionMode.Callback, OnFastScrollStateChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        contacts = stream(MyApplication.userList.values())
                .where(c -> c.isFriend() && !c.isBlocked())
                .toList();
        ...
        recyclerView = rootView.findViewById(itemList);
    ...
    public void onAttach(Context context) {
        ...
        ((ContactsActivity) getActivity()).callbackContacts = this;
    ...
    public void onDetach() {
        ...
        ((ContactsActivity) getActivity()).callbackContacts = null;
        ...
        if (persons.size() > 0) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.contact_block:
                    ...
                    new MaterialDialog.Builder(getActivity()).theme(Theme.LIGHT).titleColorRes(R.color.normal_blue).negativeColorRes(R.color.dialog_negetive_button).positiveColorRes(R.color.normal_blue).title("Block Contacts").content("Are you want to block these contacts?").positiveText("Block").onPositive((dialog, which) -> {
    ...
    public void onItemClicked(final int position) {
        if (mAdapter.isMultiSelect()) {
            ...
            new MaterialDialog.Builder(getActivity()).theme(Theme.LIGHT).titleColorRes(R.color.normal_blue).negativeColorRes(R.color.dialog_negetive_button).positiveColorRes(R.color.normal_blue).title("Block Contact").content("Are you want to block this contact?").positiveText("Block").onPositive((dialog, which) -> {
