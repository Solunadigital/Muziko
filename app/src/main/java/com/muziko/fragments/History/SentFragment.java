...
public class SentFragment extends BaseFragment implements SharingCallback, ShareListener, MaterialMenuAdapter.Callback {

    private final String TAG = SentFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new SharedFilesAdapter(getActivity(), shares, contacts, TAG, MyApplication.SHARING_SENT, this);
        ...
        mRecyclerView = rootView.findViewById(itemList);
...
//        handler.postDelayed(checkforSync, 1000);
    ...
    public void onAttach(Context context) {
        ...
        ((HistoryActivity) getActivity()).callbackSent = this;
    ...
    public void onDetach() {
        ...
        ((HistoryActivity) getActivity()).callbackSent = null;
    ...
    private void reload() {
        ...
        shares.addAll(ShareRealmHelper.getSentShares());
