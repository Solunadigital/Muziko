...
public class ReceivedFragment extends BaseFragment implements SharingCallback, ShareListener, MaterialMenuAdapter.Callback {
    private final String TAG = ReceivedFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new SharedFilesAdapter(getActivity(), shares, contacts, TAG, MyApplication.SHARING_RECEIVED, this);
...
//        handler.postDelayed(checkforSync, 1000);
    ...
    public void onAttach(Context context) {
        ...
        ((HistoryActivity) getActivity()).callbackReceived = this;
    ...
    public void onDetach() {
        ...
        ((HistoryActivity) getActivity()).callbackReceived = null;
    ...
    private void toggleSelection(int position) {
        ((SelectableAdapter) mRecyclerView.getAdapter()).toggleSelection(position);

        int count = ((SelectableAdapter) mRecyclerView.getAdapter()).getSelectedItemCount();
    ...
    private void reload() {
        ...
        contacts.clear();
        contacts.addAll(MyApplication.userList.values());
        ...
        shares.addAll(ShareRealmHelper.getReceivedShares());

//        Collections.sort(shares, (o1, o2) -> {
//            long time1 = (Long) o1.getTimestamp();
//            long time2 = (Long) o2.getTimestamp();
//
