...
public class GenreAdapter extends SelectableAdapter<GenreAdapter.AdapterQueueHolder> implements Filterable, FastScrollRecyclerView.SectionedAdapter {
	...
	public GenreAdapter(Context context, ArrayList<QueueItem> listData, String tag, RecyclerItemListener listener) {
		super();
		this.mContext = context;
		this.items = listData;
		this.filts = listData;
		this.type = PlayerConstants.QUEUE_TYPE_GENRES;
		mtag = tag;
	...
	public void onBindViewHolder(final AdapterQueueHolder holder, int position) {
		...
		if (item != null) {
			...
			if (gridtype == GRID1) {
				...
				if (MyApplication.showArtwork) {
//					MyApplication.loadImageSmallFresco(item, holder.i/mageThumb);
...
//				MyApplication.loadImageFresco(item, holder.imageThumb);
    ...
    public int getItemViewType(int position) {
        ...
        return PrefsManager.Instance().getGenresViewType();
    }
...
//		}
	...
	public class AdapterQueueHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
