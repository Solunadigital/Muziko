...
public class AlbumAdapter extends SelectableAdapter<AlbumAdapter.AdapterQueueHolder> implements Filterable, FastScrollRecyclerView.SectionedAdapter {
	...
	public AlbumAdapter(Context context, ArrayList<QueueItem> listData, String tag, RecyclerItemListener listener) {
		super();
		this.mContext = context;
		this.items = listData;
		this.filts = listData;
		this.type = PlayerConstants.QUEUE_TYPE_ALBUMS;
		mtag = tag;
