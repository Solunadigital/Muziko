...
public class DownloadFileAdapter extends SelectableAdapter<DownloadFileAdapter.AdapterQueueHolder> implements Filterable, FastScrollRecyclerView.SectionedAdapter {
    ...
    public DownloadFileAdapter(Context context, ArrayList<QueueItem> listData, int type, boolean showArtwork, String tag, RecyclerItemListener listener) {
        super();
