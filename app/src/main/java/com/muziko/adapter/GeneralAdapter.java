...
public class GeneralAdapter extends SelectableAdapter<GeneralAdapter.AdapterQueueHolder> implements Filterable, FastScrollRecyclerView.SectionedAdapter {
    ...
    public GeneralAdapter(Context context, ArrayList<QueueItem> listData, int type, boolean showArtwork, String tag, RecyclerItemListener listener) {
        super();
...
//					MyApplication.loadImageFresco(item, holder.imageThumb);
    ...
    public void sortPlaylistLowest() {
    ...
    public void sortplaylistHighest() {
