package com.muziko.api.Lyrics;


import com.muziko.annotations.Reflection;
import com.muziko.common.models.Lyrics;
import com.muziko.helpers.NetworkHelper;
...
import static com.muziko.common.models.Lyrics.NEGATIVE_RESULT;
import static com.muziko.common.models.Lyrics.NO_RESULT;
import static com.muziko.common.models.Lyrics.POSITIVE_RESULT;
import static com.muziko.common.models.Lyrics.SEARCH_ITEM;
...
public class ViewLyrics {
    ...
    public static Lyrics fromMetaData(String artist, String title) throws IOException, NoSuchAlgorithmException, SAXException, ParserConfigurationException {
        ...
        int artistDistance = Utils.levenshteinDistance(results.get(0).getArtist(), artist);
        int titleDistance = Utils.levenshteinDistance(results.get(0).getTrack(), title);
        ...
        result.setText(NetworkHelper.getUrlAsString(url).replaceAll("(\\[(?=.[a-z]).+\\]|<.+?>|www.*[\\s])", "").replaceAll("[\n\r]", " ").replaceAll("\\[", "\n\\["));
    ...
    private static byte[] assembleQuery(byte[] valueBytes) throws NoSuchAlgorithmException, IOException {
    ...
    private static ArrayList<Lyrics> parseResultXML(String resultXML) throws SAXException, IOException, ParserConfigurationException {
