...
public class Util {
	...
	private static void confirmDialog(Context ctx, String msg, int posButton,
	                                  int negButton, OnClickListener onPositive) {
		new AlertDialog.Builder(ctx).setTitle("Are you sure")
		...
		try {
			...
			NotificationCompat.Builder builder =
					new NotificationCompat.Builder(mCtx)
							...
							.setSmallIcon(R.drawable.ic_tag_album)
