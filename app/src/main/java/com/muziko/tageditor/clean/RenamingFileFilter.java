...
import com.muziko.tageditor.util.FileComparator;
import com.muziko.tageditor.util.FileFilter;
...
public abstract class RenamingFileFilter implements FileFilter {
	...
	//					.getNewName2(s));
	//		}
	//		//		new MusicOrganizerFilter().toTitleCase("SinAd O'connor");
	//	}
