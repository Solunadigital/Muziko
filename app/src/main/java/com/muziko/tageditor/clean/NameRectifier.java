...
package com.muziko.tageditor.clean;

import com.crashlytics.android.Crashlytics;
import com.muziko.tageditor.metadata.MusicMetadataConstants;
import com.muziko.tageditor.util.MyComparator;
import com.muziko.tageditor.util.MyMap;
import com.muziko.tageditor.util.TextUtils;
...
public class NameRectifier implements MusicMetadataConstants {
	...
	private static final String DEFAULTS_VA[] = {
			...
			"Va", //
			"V A", //
            "Various ArtistsFragment", //
            "Various", //
            "Varioius", //
            "Varied ArtistsFragment", //
            "Varias", //
            "Varios Interpretes", //
			"Varios", //
			"Various Artist", //
