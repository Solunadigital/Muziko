...
package com.muziko.tageditor.fs;

import com.muziko.tageditor.clean.NameRectifier;
...
public abstract class FSParser {
	...
	public static MusicMetadata parseFilename(String fileName,
                                              String folderName) {
		if (fileName == null)
			return null;
        ...
        String kVariousArtists = "Various ArtistsFragment";
        String album = null;
