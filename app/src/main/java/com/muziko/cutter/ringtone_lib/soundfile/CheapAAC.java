...
package com.muziko.cutter.ringtone_lib.soundfile;
...
public class CheapAAC extends CheapSoundFile {
	...
	private static final int kFTYP = 0x66747970;
	...
	private static final int kSTCO = 0x7374636f;
	private static final int kSTSC = 0x73747363;
	...
	private static final int[] kRequiredAtoms = {
			kDINF,
			kHDLR,
			kMDHD,
			kMDIA,
	...
	private String atomToString(int atomType) {
		String str = "";
	...
	private void parseStts(InputStream stream)
			throws java.io.IOException {
	...
	private void parseStsz(InputStream stream)
			throws java.io.IOException {
	...
	private void parseMdat(InputStream stream, int maxLen)
			throws java.io.IOException {
	...
	private void WriteAtom(FileOutputStream out, int atomType)
			throws java.io.IOException {
	...
	private void SetAtomData(int atomType, byte[] data) {
		Atom atom = mAtomMap.get(atomType);
		if (atom == null) {
			atom = new Atom();
			mAtomMap.put(atomType, atom);
